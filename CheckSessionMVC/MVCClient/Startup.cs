        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            JwtSecurityTokenHandler.DefaultMapInboundClaims = false;
                ...
                services.AddAuthentication(options =>
                    ...
                    {
                        //options.Authority = "https://auth.domain.com.au/v1";
                        //options.Authority = "https://stage-auth.domain.com.au/v1";
                        //options.Authority = "https://stage-auth2.domain.com.au/v1";
                       // options.Authority = "https://dev-auth.domain.com.au/v1";
                        ...
                        //options.ClientId = "identity-server-admin-ui";
                        //options.ClientSecret = "d32456d0250a4d3d9427b31eed84eea0";
